# old impl from python2 circa 2010... minimal changes to run in python3
...
for i in buttons:
    button_style = 'raised'
    action = lambda x = i: click_event(x) # assigning custom handling from click_event case below
...
display = tk.Entry(calc, width = 40, bg = "white") # calculator screen 
